...
function sortByGrade(students) {
  let sortedStudents = students.toSorted(function(a, b){return b.grade - a.grade});
  return sortedStudents;
}

function sortByAgeAndGrade(students) {
  //
  let sortedStudentsByAgeAndGrade = students.toSorted(function(a,b){return a.age - b.age});
  for(n in sortedStudentsByAgeAndGrade){
    if(n.age === (n + 1).age ){
      sortedStudentsByAgeAndGrade = students.toSorted(function(a,b){return b.grade - a.grade});
    }
  }
  return sortedStudentsByAgeAndGrade;
}
